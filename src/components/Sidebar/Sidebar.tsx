...
const SidebarItem: React.FC<SidebarItemProps> = ({ 
  ...
  return (
    <div 
      ...
      `}
    >
      <div className="flex-shrink-0 text-gray-600 dark:text-gray-400 group-hover:text-blue-500 transition-colors">
        {icon}
      </div>
      {extended && (
        <span className="text-gray-700 dark:text-gray-300 text-xs whitespace-nowrap overflow-hidden text-ellipsis group-hover:text-gray-900 dark:group-hover:text-gray-100 transition-colors">
          {text}
        </span>
      )}
    </div>
...
const Sidebar: React.FC = () => {
  ...
  const QuestionIcon = () => (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20ZM11 17H13V15H11V17ZM11 13H13V7H11V13Z" fill="currentColor" />
    </svg>
  );

  const HistoryIcon = () => (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M13 3C8.03 3 4 7.03 4 12H1L5 16L9 12H6C6 8.13 9.13 5 13 5C16.87 5 20 8.13 20 12C20 15.87 16.87 19 13 19C11.07 19 9.32 18.22 8.11 16.95L6.69 18.36C8.27 20.05 10.53 21 13 21C18.52 21 23 16.52 23 12C23 7.48 18.52 3 13 3ZM12 8V13L16.25 15.52L17.02 14.24L13.5 12.25V8H12Z" fill="currentColor" />
    </svg>
  );
  ...
  return (
    <>
      ...
      <aside 
        className={`
          ${isMobile ? 'fixed' : 'relative'} left-0 top-0 h-screen z-20
          ${
            isDarkMode 
      ...
      >
        ...
        <div className="space-y-4 md:space-y-6">
          ...
          {(extended || (isMobile && isOpen)) && previousPrompt && previousPrompt.length > 0 && (
            <div className="mt-4">
              <h2 className="text-xs font-medium text-gray-500 dark:text-gray-400 px-2 mb-2 uppercase tracking-wide">Recent</h2>
        ...
        {/* Bottom Section */}
        <div className="space-y-1 mt-auto pt-2 border-t border-gray-200/50 dark:border-gray-700/50">
          <SidebarItem
            icon={<QuestionIcon />}
            text="Help"
            extended={extended || (isMobile && isOpen)}
      ...
      {isMobile && !isOpen && (
        <button
          ...
          className={`
            fixed top-3 left-3 z-30 p-2 rounded-xl backdrop-blur-sm
            transition-all duration-300
            ${
              isDarkMode 
